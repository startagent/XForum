	...
	build: {
		...
		rollupOptions: {
			input: {
				...
				'soul-deep': path.resolve(__dirname, 'pages', 'soul-deep.html'),
				enneagram: path.resolve(__dirname, 'pages', 'enneagram.html'),
				bdsm: path.resolve(__dirname, 'pages', 'bdsm.html'),
				scenarios: path.resolve(__dirname, 'pages', 'scenarios.html'),
				'scenario-play': path.resolve(__dirname, 'pages', 'scenario-play.html'),
				'scenario-editor': path.resolve(__dirname, 'pages', 'scenario-editor.html'),
